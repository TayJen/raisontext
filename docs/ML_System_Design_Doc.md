...
Решаем задачу бинарной классификации текстовых документов на синтетически сгенерированные или реальные, обязательно интерпритируем предсказанную вероятность.
